...
function renderAppointmentCard(appointment) {
    ...
    <div class="flex flex-wrap items-start justify-between gap-4">
      ...
      <a href="${whatsappUrl}" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 rounded-full bg-emerald-600 px-3 py-2 text-xs font-semibold text-white transition hover:bg-emerald-500" title="Falar com ${escapeHtml(appointment.customerName)} no WhatsApp">
